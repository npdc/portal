...
class ZipFile {
    ...
    public function create($user) {
        ...
        if (!mkdir($this->downloadDir . $this->filename)) {
            ...
            $this->zipModel = new \npdc\model\Zip();
            $this->zipId = $this->zipModel->insertZip(
    ...
    public function addFile($id) {
        ...
        symlink(
            $this->dataDir.$file['location'],
            $this->downloadDir.$this->filename.'/'.$file['name']
        );
    ...
    public function addMeta($meta) {
        file_put_contents(
            $this->downloadDir . $this->filename.'/metadata.txt',
            $meta
        );
    }
    ...
    public function generate() {
        exec(
            'cd ' . $this->downloadDir . $this->filename . ';zip ../' 
            . $this->filename . '.zip * > ../' . $this->filename . '.log &'
        );
    }
}