...
?>
<h4>Dataset</h4><p><a href="<?=BASE_URL?>/dataset/<?=$this->data['dataset_id']?>"><?=$this->controller->modelDataset->getById($this->data['dataset_id'])['title']?></a></p>

<section class="inline"><h4>Request date</h4><p><?=date('Y-m-d H:i', strtotime($this->data['request_timestamp']))?></p></section>
	
<h4>Reason</h4>
<p><?=$this->data['reason']?></p>
