...
class Db {
            ...
            try {
                $instance = new PDO(
                    $db['type'] 
                        ...
                        . ';dbname=' . $db['name']
                        . ';port=' . (
                            $db['port'] ?? self::$defaultPorts[$db['type']]
                        ),
                    $db['user'],
                    $db['pass'],
                    $pdo_options
    ...
    /**
     * Provide on clause for joining extra tables to project, dataset or 
     * publication
     *
     ...
     * @param integer $id id of the record (can be ommitted, actually version 
     *              can be ommitted, in that case id will be used as version)
