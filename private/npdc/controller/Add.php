    ...
    public function __construct($session) {
        ...
        switch (\npdc\lib\Args::get('action')) {
            ...
            case 'publication':
                ...
                $this->formController->form->fields->people->fields
                    ->organization_id->options = $this->getOrganizations();
                $this->formController->form->fields->submit
                    ->value = 'Save and add';
        ...
        if (isset($_POST['formid'])) {
            ...
            switch (\npdc\lib\Args::get('action')) {
                ...
                case 'organization':
                    $_SESSION[$this->formId]['data'] = [];
                    $_SESSION[$this->formId]['data']['organization_name'] = 
                        urldecode(\npdc\lib\Args::get('subaction'));
                    $_SESSION[$this->formId]['data']['country_id'] = 'NL';
                    break;
                case 'publication':
                    $_SESSION[$this->formId]['data'] = [];
                    $_SESSION[$this->formId]['data']['title'] = 
                        urldecode(\npdc\lib\Args::get('subaction'));
                    break;
        ...
        switch (\npdc\lib\Args::get('action')) {
            case 'person':
                ...
                if ($model->checkMail(
                    ...
                    $id = $model->insertPerson(
                        $_SESSION[$this->formId]['data']
                    );
                    $this->return = [
                        'id' => $id,
                        'label' => $_SESSION[$this->formId]['data']['name'],
                        'nextfield' => 
                            $_SESSION[$this->formId]['data']['organization_id']
                    ];
            ...
            case 'publication':
                ...
                $this->return = [
                    'id'=>$id,
                    'label'=>$_SESSION[$this->formId]['data']['title']
                ];
                unset($_SESSION[$this->formId]);
        }
    }
